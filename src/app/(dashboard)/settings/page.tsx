...
export default function SettingsPage() {
  ...
  return (
    <div className="max-w-3xl">
      <h1 className="text-3xl font-bold mb-6">Cài Đặt Hồ Sơ</h1>
      ...
      <div className="bg-gradient-to-br from-[#2b161b] to-[#1a0f12] rounded-[30px] p-6">
        ...
        <p className="text-white/70 text-sm mb-6">
          Thêm liên kết đến các trang mạng xã hội của bạn. Mỗi mạng xã hội chỉ có thể thêm 1 liên kết.
        </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full bg-card-bg border border-white/10 rounded-lg px-4 py-2 text-white placeholder-white/30 focus:outline-none focus:border-accent-primary transition-colors"
            />
          </div>
