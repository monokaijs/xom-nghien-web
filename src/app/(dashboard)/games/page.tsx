...
import { IconSearch, IconLoader2, IconAlertTriangle, IconGamepad2 } from '@tabler/icons-react';
              ...
              <div className="aspect-[16/9] relative overflow-hidden">
                {game.postImage ? (
                  ...
                  <div className="w-full h-full bg-bg-dark flex items-center justify-center">
                    <IconGamepad2 size={40} className="text-text-secondary/30" />
                  </div>
                )}
