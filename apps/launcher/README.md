...
The Servers home screen also offers one-click installation of the latest `Creaton-Valheim_Viet_Hoa` into a selected personal profile. When no profile is selected, the launcher creates and synchronizes a new `Default` profile first.
